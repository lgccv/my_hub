...
class yolo26Segment:
    def __init__(self,resize=(320,320),score_threshold = 0.2):
        ...
        self.model_path = "/home/std/workspace-hub/lgc/yolov26/runs/segment/train-5/weights/last.onnx"
        providers = ['CUDAExecutionProvider','CPUExecutionProvider']
        self.session = ort.InferenceSession(self.model_path,providers=providers)

        print("当前推理后端是:",self.session.get_providers())
    ...
    def infer(self,images):
        ...
        return self.session.run(self.output_name, {self.input_name: images["input"]})
